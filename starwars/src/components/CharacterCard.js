...
import {Card, CardHeader, CardTitle, CardBody, CardText, CardSubtitle, Button} from "reactstrap";
    ...
    return (
        <Card>
            ...
            <CardBody>
                ...
                <Button a href="https://www.starwars.com/" className="button">StarWars Website</Button>
            </CardBody>
        </Card>
   );
  };
